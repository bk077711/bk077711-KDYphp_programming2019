...
if(isset($_GET[num])) {
    ...
    $sql = "select * from tableboard where id = '$_GET[num]'";
					...
					<table>
						...
						<tr>
                            ...
                            if(isset($_GET[num])) { //update 의 경우!
                                ?>
                                <td class="column1"> <input name="date" type="text" value="<? echo "$find[write_date]"; ?>" /> </td>
                                <td class="column2"> <input name="order_id" type="number" value="<? echo"$find[id]"; ?>" /> </td>
                                <td class="column3"> <input name="name" type="text" value="<?  echo "$find[name]"; ?>" /> </td>
                                <td class="column4"> <input name="price" type="number" placeholder="$" style="text-align: right;" value="<?echo "$find[price]"; ?>" /> </td>
                                <td class="column5"> <input name="quantity" type="number" value="<? echo "$find[quantity]"; ?>" style="text-align: right;" /> </td>
                                <td class="column6"> $<span id="total"> <? $mul = $find[price] * $find[quantity]; echo "$mul"; ?> </span> </td>
                                <?php
                            } else {
                                ?>
